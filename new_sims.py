...
print('kSZ realizations numbers = %s' %ksz_g_realizations)
...
# bias_err_compare = factor**2*st_t.stats['reckap_x_reckap']['errmean']/(st_t.stats['inkap_x_inkap']['mean'])
bias_err = st_tg.stats['reckap_x_reckap']['errmean']/(st_t.stats['inkap_x_inkap']['mean'])
...
# Data_dict['bias_err_compare'] = bias_err_compare
Data_dict['bias_err'] = bias_err
